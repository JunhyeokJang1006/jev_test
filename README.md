...
시장에서 [무기·갑옷](docs/equipment.md)을 구매하고 장착해 명중·피해·방어·은신을 조절할 수 있습니다.
원정 이후에는 [파벌 수송·정산 사건](docs/world-events.md)이 게임 시간에 따라 진행됩니다.
구조 결과와 지원 여부가 파벌 물자·신뢰·시장 가격에 영향을 줍니다.
