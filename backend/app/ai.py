    ...
    messages = [
        {
            ...
            "content": (
                ...
                "difficulty_band moderate. Only for explicitly attacking a goblin "
                "use intent basic_attack, "
                "action_type attack, target_ids ['goblin_001'], skill null, difficulty_band null. "
                "Never retarget an attack against another NPC to a goblin. "
                ...
                "followup_check, resolve_followup, recover, buy_resource. "
